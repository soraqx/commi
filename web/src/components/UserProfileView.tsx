...
export function UserProfileView({ onHapticSettingChange }: UserProfileViewProps) {
    ...
    const testVibration = async () => {
        console.log("1. Button clicked. Attempting RAW vibration...");
        try {
            // Replaced impact() with vibrate() for a guaranteed 500ms buzz
            await Haptics.vibrate({ duration: 500 });
            console.log("2. Raw vibrate promise resolved!");
        } catch (error) {
